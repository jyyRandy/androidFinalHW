...
class News2DetailAdapter(private val context: Context, private val commentList: MutableList<CommentBean.Comments>
): RecyclerView.Adapter<News2DetailAdapter.ViewHolder>() {
